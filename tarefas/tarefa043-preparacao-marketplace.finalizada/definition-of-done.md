...
- [ ] package.json contem icon e galleryBanner configurados
- [ ] .vscodeignore exclui arquivos desnecessarios (tests, src, docs, .github)
- [ ] `vsce ls` mostra apenas arquivos necessarios para distribuicao
- [ ] `vsce package` gera .vsix sem erros ou warnings
- [ ] .vsix instalado manualmente funciona corretamente
- [ ] Preview da pagina do Marketplace verificada (via README renderizado)
